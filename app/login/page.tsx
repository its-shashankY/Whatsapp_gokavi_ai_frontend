...
export default function LoginPage() {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    // Placeholder auth: any credentials are accepted for the selected role.
    // Real authentication against the hospital's identity provider is not
    // wired up yet.
      ...
      <main className="w-full max-w-md bg-surface-container-lowest rounded-xl shadow-[0_8px_30px_rgb(7,2,53,0.04)] border border-primary-fixed/20 overflow-hidden relative">
        ...
        <div className="p-8 md:p-10 flex flex-col gap-8 relative z-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
            <div className="flex flex-col gap-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  id="identifier"
                  name="identifier"
                  placeholder="user@gokavi.hospital"
                  required
                  type="text"
                  value={identifier}
            ...
            <div className="flex flex-col gap-2">
              <span className="font-label-caps text-label-caps text-primary uppercase">Sign in as</span>
              <div className="grid grid-cols-2 gap-2 bg-surface-container-low p-1 rounded-lg">
                {(
                  [
                    { value: "receptionist", label: "Reception / Triage", icon: "support_agent" },
                  ...
                  <button
                    ...
                    className={cn(
                      "flex items-center justify-center gap-2 py-2.5 rounded-md font-button text-button text-sm transition-all",
                      role === option.value
              ...
              <p className="text-xs text-on-surface-variant">
                This is a placeholder role switch for demo purposes — real staff accounts and
                permissions will be wired up with hospital authentication later.
              </p>
            </div>
